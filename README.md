...
![Adressen](https://img.shields.io/badge/adressen-6.995.223-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-17--01--2026-brightgreen)
...
- **Gewestbestanden** (3 bestanden): CSV-bestanden van alle adressen, gesplitst per gewest:
    - Vlaanderen.csv.zst (4.180.192 adressen)
    - Brussel.csv.zst (834.734 adressen)
    - Wallonië.csv.zst (1.980.297 adressen)
