...
![Adressen](https://img.shields.io/badge/adressen-7.004.087-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-14--02--2026-brightgreen)
...
- **Gewestbestanden** (3 bestanden): CSV-bestanden van alle adressen, gesplitst per gewest:
    - Vlaanderen.csv.zst (4.183.602 adressen)
    - Brussel.csv.zst (837.123 adressen)
    - Wallonië.csv.zst (1.983.362 adressen)
