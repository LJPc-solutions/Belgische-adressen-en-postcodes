...
![Adressen](https://img.shields.io/badge/adressen-6.990.599-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-03--01--2026-brightgreen)
...
- **België.csv.zst** (30M): dit archief bevat een CSV-bestand met alle Belgische adressen en de volgende gegevens:
    - Straatnaam
    - Huisnummer
    - Busnummer
    - Postcode
...
- **Gewestbestanden** (3 bestanden): CSV-bestanden van alle adressen, gesplitst per gewest:
    - Vlaanderen.csv.zst (4.177.578 adressen)
    - Brussel.csv.zst (834.022 adressen)
    - Wallonië.csv.zst (1.978.999 adressen)
