...
![Adressen](https://img.shields.io/badge/adressen-7.078.457-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-16--05--2026-brightgreen)
...
- **Gewestbestanden** (3 bestanden): CSV-bestanden van alle adressen, gesplitst per gewest:
    - Vlaanderen.csv.zst (4.197.282 adressen)
    - Brussel.csv.zst (842.593 adressen)
    - Wallonië.csv.zst (2.038.582 adressen)
