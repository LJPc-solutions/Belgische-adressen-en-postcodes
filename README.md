...
![Adressen](https://img.shields.io/badge/adressen-7.088.044-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-13--06--2026-brightgreen)
...
- **Gewestbestanden** (3 bestanden): CSV-bestanden van alle adressen, gesplitst per gewest:
    - Vlaanderen.csv.zst (4.203.210 adressen)
    - Brussel.csv.zst (843.974 adressen)
    - Wallonië.csv.zst (2.040.860 adressen)
