...
![Adressen](https://img.shields.io/badge/adressen-7.089.348-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-27--06--2026-brightgreen)
...
- **Gewestbestanden** (3 bestanden): CSV-bestanden van alle adressen, gesplitst per gewest:
    - Vlaanderen.csv.zst (4.204.255 adressen)
    - Brussel.csv.zst (844.386 adressen)
    - Wallonië.csv.zst (2.040.707 adressen)
