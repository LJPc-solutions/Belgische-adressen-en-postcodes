...
![Adressen](https://img.shields.io/badge/adressen-6.999.614-brightgreen) ![Laatste update](https://img.shields.io/badge/laatste%20update-31--01--2026-brightgreen)
...
- **Gewestbestanden** (3 bestanden): CSV-bestanden van alle adressen, gesplitst per gewest:
    - Vlaanderen.csv.zst (4.181.545 adressen)
    - Brussel.csv.zst (836.291 adressen)
    - Wallonië.csv.zst (1.981.778 adressen)
